...
const MenuItem = (props) => {
  const { name } = props;
  return (
    <div className="flex items-center justify-center cursor-pointer mr-4 mb-4 border-2 border-seller-accent rounded-2xl w-64 h-28 bg-seller-card hover:bg-seller-accent text-seller-text hover:text-white duration-300">
