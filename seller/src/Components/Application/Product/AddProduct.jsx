...
export default function AddProduct() {
  ...
  const renderVariantsList = () => {
    ...
    return (
      <div>
        <label className="text-sm py-2 ml-1 font-medium text-left text-seller-text inline-block mt-2">
          Select Variants
        </label>
        <Box sx={{ display: "flex" }}>
          <FormControl
  ...
  const renderVariants = () => {
    return (
      <FormControl>
        <div className="text-sm py-2 ml-1 font-medium text-left text-seller-text inline-block mt-2">
          Variation On
        </div>
        <RadioGroup
