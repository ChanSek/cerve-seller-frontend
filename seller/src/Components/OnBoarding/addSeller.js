...
const AddSeller = () => {
  ...
  return (
    <div
      className="mx-auto !p-5 h-screen min-vh-100 overflow-auto bg-seller-bg"
      style={{ height: "100%", marginTop: "10px" }}
    >
      <div className="h-full flex fex-row items-center justify-center">
        <div
          className="flex w-full md:w-2/4 bg-seller-card border border-seller-elevated px-4 py-4 rounded-md shadow-xl h-max"
        // style={{ minHeight: "75%" }}
        >
