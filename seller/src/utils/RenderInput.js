      ...
      <div className={props.containerClasses !== undefined ? `${props.containerClasses}` : "py-1 flex flex-col"}>
        <label
          className={
            props.labelClasses
              ? props.labelClasses
              : "text-sm py-2 ml-0 font-medium text-left text-seller-text inline-block"
          }
        >
          {item.title}
              ...
              >
                {item.options.map((radioItem, i) => (
                  <FormControlLabel
                    ...
                    label={<div className="text-sm font-medium text-seller-text">{radioItem.key}</div>}
                  />
                ))}
              </div>
            </RadioGroup>
        ...
        <FormGroup row>
          {item.options.map((checkboxItem) => (
            <FormControlLabel
              ...
              label={
                <div className="text-sm font-medium text-seller-text" key={checkboxItem.key}>
                  {checkboxItem.key}
                </div>
              }
            />
      ...
      if (typeof state[item.id] == "string") {
        ...
        return (
          <div style={{ height: 100, width: 100, marginBottom: 40, marginTop: 10 }} className="flex">
            <label className="text-sm py-2 ml-0 font-medium text-left text-seller-text inline-block">{item.title}</label>
